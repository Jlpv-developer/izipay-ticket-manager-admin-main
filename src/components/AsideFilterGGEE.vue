<template>
 ...
 <h5 class="subtitle is-5">Estados</h5>
      ...
      <b-checkbox
        ...
        >Kick Off</b-checkbox
      >
      Kick Off,En proceso, Pruebas en producción
      <br />
      <b-checkbox
        class="is-small"
        v-model="ticketFilter.state"
      ...
      <b-checkbox
        ...
        >Pruebas en producción</b-checkbox
      >
...
export default {
  ...
  data() {
    return {
      ...
      open:["Kick Off","En proceso", "Pruebas en producción"],
      cancel:["Kick Off - Cancelado","Retorno Comercial","Retorno Técnico"],
      complete:["Capacitación BO"],
      selected: [],
      allSelected: false,
      indeterminate: false,
      selected2: [],
